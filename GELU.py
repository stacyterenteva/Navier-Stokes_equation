...
class NavierStokes():
    def __init__(self, X, Y, T, u, v):
        ...
        self.optimizer = torch.optim.LBFGS(self.net.parameters(), lr=1e-1, max_iter=2000, max_eval=5000,
    ...
    def network(self):
        ...
        self.net = nn.Sequential(
            nn.Linear(3, 20), nn.GELU(),
            nn.Linear(20, 20), nn.GELU(),
            nn.Linear(20, 20), nn.GELU(),
            nn.Linear(20, 20), nn.GELU(),
            nn.Linear(20, 20), nn.GELU(),
            nn.Linear(20, 20), nn.GELU(),
...
# # Call animate method
# ani = animation.FuncAnimation(fig, animate, N_train, interval=1, blit=False)
